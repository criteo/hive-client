...
public class TExecuteStatementResp implements org.apache.thrift.TBase<TExecuteStatementResp, TExecuteStatementResp._Fields>, java.io.Serializable, Cloneable, Comparable<TExecuteStatementResp> {
  ...
  public TOperationHandle operationHandle; // optional
  ...
  public TExecuteStatementResp setStatus(TStatus status) {
    this.status = status;
    return this;
  }
  ...
  public TExecuteStatementResp setOperationHandle(TOperationHandle operationHandle) {
