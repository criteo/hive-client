...
public class TI16Column implements org.apache.thrift.TBase<TI16Column, TI16Column._Fields>, java.io.Serializable, Cloneable, Comparable<TI16Column> {
  ...
  public java.util.List<java.lang.Short> values; // required
  public java.nio.ByteBuffer nulls; // required
  ...
  public TI16Column setValues(java.util.List<java.lang.Short> values) {
    this.values = values;
    return this;
  }
  ...
  public TI16Column setNulls(java.nio.ByteBuffer nulls) {
    this.nulls = org.apache.thrift.TBaseHelper.copyBinary(nulls);
    return this;
  }
