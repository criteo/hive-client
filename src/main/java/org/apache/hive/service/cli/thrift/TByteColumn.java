...
public class TByteColumn implements org.apache.thrift.TBase<TByteColumn, TByteColumn._Fields>, java.io.Serializable, Cloneable, Comparable<TByteColumn> {
  ...
  public java.util.List<java.lang.Byte> values; // required
  ...
  public TByteColumn setValues(java.util.List<java.lang.Byte> values) {
    this.values = values;
    return this;
  }
  ...
  public TByteColumn setNulls(java.nio.ByteBuffer nulls) {
    this.nulls = org.apache.thrift.TBaseHelper.copyBinary(nulls);
    return this;
  }
