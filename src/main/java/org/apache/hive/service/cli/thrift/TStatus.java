...
public class TStatus implements org.apache.thrift.TBase<TStatus, TStatus._Fields>, java.io.Serializable, Cloneable, Comparable<TStatus> {
   ...
   * @see TStatusCode
   */
  public TStatusCode statusCode; // required
  public java.util.List<java.lang.String> infoMessages; // optional
   ...
   * @see TStatusCode
   */
  public TStatus setStatusCode(TStatusCode statusCode) {
    this.statusCode = statusCode;
    return this;
  }
  ...
  public TStatus setInfoMessages(java.util.List<java.lang.String> infoMessages) {
  ...
  public TStatus setSqlState(java.lang.String sqlState) {
  ...
  public TStatus setErrorMessage(java.lang.String errorMessage) {
