...
object HiveCLI {
  ...
  class PrintLnLogger extends HiveClientLogger {
    override def info(str: CharSequence): Unit = println(str)
    override def error(str: CharSequence): Unit = println(str)
    override def debug(str: CharSequence): Unit = println(str)
  }
...
class HiveCLI(credentials: HiveCredentials,
  ...
  def executeQuery(sql: String,
                   database: String,
                   hiveConf: Map[String, String] = new HashMap[String, String],
                   hiveVar: Map[String, String] = new HashMap[String, String]): Future[Unit] = {
